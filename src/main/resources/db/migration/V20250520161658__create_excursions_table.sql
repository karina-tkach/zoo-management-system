...
VALUES
    ...
    ('Reptile Walkthrough', 4, 'Learn about lizards and snakes', CURRENT_DATE + INTERVAL '8 days', '13:30', 60, 15, 0),
    ('Bird Watching', 4, 'Observe exotic birds and their habits', CURRENT_DATE + INTERVAL '15 days', '09:00', 45, 10, 0);